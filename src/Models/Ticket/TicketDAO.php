...
class TicketDAO extends DAO
{
    ...
    public function getCountList(string $searchFor = null, string|int $user = null, int $status = 1)
    {
        $query = "SELECT COUNT(*) FROM CHAMADOS INNER JOIN USUARIOS ON USUARIOS.US_ID = CHAMADOS.ID_USUARIO INNER JOIN ESTADO ON ESTADO.ES_ID = CHAMADOS.ID_ESTADO";
